...
interface GalleryItem {
  ...
  description: string;
  image: string;
  category: "UI/UX" | "Front-End Dev" | "Full-Stack Dev" | "Product Management" | "Project Management";
  tags?: string[];
  githubUrl?: string;
}
...
const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    category: "Front-End Dev",
    tags: ["Product Management", "Product Design", "UX/UI Design"],
  ...
  },
  {
    ...
    image: "https://cdn.builder.io/api/v1/image/assets%2F2fee5fb64ed040cfbb079c9f4e5444d0%2F423996dd15c7415391c848bca8a12003",
    category: "UI/UX",
    tags: ["User Interviews", "Lo-fi Prototype", "Conceptual Models"],
  },
  {
    title: "The Last Laugh",
    description: "2D pixelated game that follows our heroine in defeating misogynistic comedian Rat Rife with tomatoes!",
    image: "https://cdn.builder.io/api/v1/image/assets%2F2fee5fb64ed040cfbb079c9f4e5444d0%2F6c4139eb0cbd43448338c9ba4cf8c012",
    category: "Full-Stack Dev",
    tags: ["Game Design", "Sprites", "Storytelling"],
    githubUrl: "https://github.com/chellexra/The_Last_Laugh-Vancouver_GameJam_2024/tree/main/Scenes/UI/Menus",
  },
  {
    title: "Virtual Closet",
    description: "Full-stack web application to reduce closet clutter and fashion waste.",
    image: "https://cdn.builder.io/api/v1/image/assets%2F2fee5fb64ed040cfbb079c9f4e5444d0%2F0c69801f7862448ea279dc3fd20fca65",
    category: "Full-Stack Dev",
...
export default function Index() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background via-background to-background/50">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12 mb-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-secondary mb-6 leading-tight">
                Design-focused. User-centered.
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8">
                Crafting meaningful digital experiences through research, design,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-3 border border-primary text-primary rounded-lg hover:bg-primary/5 transition-colors font-medium flex items-center justify-center gap-2"
            >
              View on LinkedIn
              <ExternalLink className="w-4 h-4" />
            </a>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-t border-border">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-serif font-bold text-secondary mb-6">About</h2>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-serif font-bold text-secondary">Professional Menu</h2>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-baseline md:justify-between mb-3 gap-2">
                  <h3 className="text-2xl font-serif font-bold text-secondary">{exp.title}</h3>
